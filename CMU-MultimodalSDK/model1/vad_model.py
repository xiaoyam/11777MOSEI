...
class LSTM(nn.Module):
    ...
    def __init__(self, latent_size, hidden_layers, output_size):
        ...
        # lstm layer
        self.lstm = nn.GRU(self.latent_size, self.latent_size, self.hidden_layers, batch_first = True)
        print("sizes", self.latent_size, self.output_size)
    ...
    def forward(self, latents):
        ...
        y_pred = self.linear(self.hidden[1])
        #print("lol", self.hidden[1].shape)
