...
def load_mosei():
    ...
    audio_valid = "../processed/data/audio_valid.h5"
    video_train = "../processed/data/video_train.h5"
    video_valid = "../processed/data/video_valid.h5"
    text_train = "../processed/data/text_train_emb.h5"
    text_valid = "../processed/data/text_valid_emb.h5"
    ey_train = "../processed/data/ey_train.h5"
    ey_valid = "../processed/data/ey_valid.h5"
